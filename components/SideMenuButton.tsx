...
const SideMenuButton = () => {
  ...
  return (
    <div>
      <button aria-label='Open side menu' className={`text-[#EDF0D8] fixed font-thin text-3xl top-[5dvh] ${pathname === "/" ? "right-[-10vw]" : "right-[2vw]"} md:text-[32px] duration-[400ms] z-50`}
