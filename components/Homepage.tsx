        ...
        <AnimatePresence>
          {showContent &&
            <div className="relative h-[100dvh] w-[100dvw]">
              ...
              >
                <Image src="/drawings/spring.png" alt="spring image" width={150} height={150} />
              </motion.div>
              <motion.div
                ...
                transition={{ duration: 0.1, delay: 0.2, type: "spring", bounce: 0.1, damping: 15, exit: { delay: 0 } }}
                className="absolute z-10 flex flex-col items-center justify-center w-[170px] h-[170px]"
                style={{ willChange: 'transform, opacity' }}
              >
                <Image src="/drawings/flower.png" alt="flower image" width={170} height={170} />
              </motion.div>
              <motion.div
                ...
                transition={{ duration: 0.1, delay: 0.2, type: "spring", bounce: 0.1, damping: 15, exit: { delay: 0 } }}
                className="absolute z-10 flex flex-col items-center justify-center w-[160px] h-[160px]"
                style={{ willChange: 'transform, opacity' }}
              >
                <Image src="/drawings/points_small.png" alt="points image" width={160} height={160} />
              </motion.div>
              <motion.div
                ...
                style={{ willChange: 'transform, opacity' }}
              >
                <Image src="/drawings/star.png" alt="star image" width={120} height={120} />
              </motion.div>
              <motion.div
                ...
                className="absolute z-10 flex flex-col items-center justify-center w-[150px] h-[150px]"
                style={{ willChange: 'transform, opacity' }}>
                <Image src="/drawings/crown.png" alt="crown image" width={150} height={150} style={{ rotate: "10deg" }} />
